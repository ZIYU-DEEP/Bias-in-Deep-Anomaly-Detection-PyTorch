...
transform_test = transforms.Compose([transforms.Resize(50),
                                     transforms.CenterCrop(32),
                                     transforms.ToTensor()])

transform_train = transforms.Compose([transforms.Resize(50),
                                      transforms.CenterCrop(32),
                                      transforms.ToTensor()])
...
# #########################################################################
class OCTResizeFolder(ImageFolder):
    """
...
# #########################################################################
class OCTResizeLoader(BaseDataset):
    def __init__(self,
        ...
        all_set = OCTResizeFolder(root=root, transform=transform_)
