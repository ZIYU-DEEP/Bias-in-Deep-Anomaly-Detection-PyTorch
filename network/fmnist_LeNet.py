...
# 1. Encoder
# #########################################################################
class FashionMNISTLeNet(BaseNet):
...
# 2. Decoder
# #########################################################################
class FashionMNISTLeNetDecoder(BaseNet):
    def __init__(self, rep_dim=64):
        super().__init__()
...
# 3. Autoencoder
# #########################################################################
class FashionMNISTLeNetAutoencoder(BaseNet):
    def __init__(self, rep_dim=64):
        super().__init__()

        self.rep_dim = rep_dim
        self.encoder = FashionMNISTLeNet(rep_dim=rep_dim)
        self.decoder = FashionMNISTLeNetDecoder(rep_dim=rep_dim)
