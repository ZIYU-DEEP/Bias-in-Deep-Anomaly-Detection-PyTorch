...
# Helper Functions
# #########################################################################
def gen_gaussian9D_hard(random_state,
                        n: int=5000,
                        mix: bool=True,
    ...
    The abnormal data is generated under this specific rule:
      - w.p. 0.4, 3 of the 9 dimensions are generated as N(1.6, 0.8).
      - w.p. 0.6, 4 of the 9 dimensions are generated as N(1.6, 0.8).
    ...
    if not mix:
        ...
        abnormal_arr = np.random.normal(1.6, 0.8, (n_abnormal, n_features))
...
# #########################################################################
class Gaussian9DHardDataset(Dataset):
    def __init__(self,
                 random_state,
                 n: int=5000,
                 mix: bool=True,
        ...
        X, y = gen_gaussian9D_hard(random_state,
                                   n,
                                   mix,
                                   ratio_abnormal,
                                   n_features)
...
# 2. Gaussian9D Loader
# #########################################################################
class Gaussian9DHardLoader(BaseLoader):
    def __init__(self,
                 random_state,
                 n: int=5000,
                 mix: bool=True,
        ...
        # Get train set
        self.all_set = Gaussian9DHardDataset(random_state,
                                             n,
                                             mix,
                                             ratio_abnormal,
                                             n_features)
